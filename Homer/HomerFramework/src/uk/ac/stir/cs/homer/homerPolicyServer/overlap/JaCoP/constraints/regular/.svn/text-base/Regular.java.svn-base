...
package uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.constraints.regular;
...
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.constraints.ExtensionalSupportSTR;
...
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.util.MDD;

...
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.IndomainMax;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.IndomainMedian;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.IndomainMiddle;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.IndomainMin;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.IndomainRandom;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.LargestDomain;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.LargestMax;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.MaxRegret;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.MostConstrainedStatic;
...
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.SmallestDomain;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.SmallestMin;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.search.SplitSelect;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.set.core.SetVar;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.set.search.IndomainSetMax;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.set.search.IndomainSetMin;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.set.search.MaxCardDiff;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.set.search.MinCardDiff;
import uk.ac.stir.cs.homer.homerPolicyServer.overlap.JaCoP.set.search.MinGlbCard;

...
public class Door extends OpenCloseSensor
{
	...
	public static final String SENSOR_DOOR_TYPE_ISLOCKED = IDUtil.getUniqueIdentifier(VisonicSensorComponent.class, "SENSOR_DOOR_TYPE_ISLOCKED");
	public static final String SENSOR_DOOR_TYPE_ISUNLOCKED = IDUtil.getUniqueIdentifier(VisonicSensorComponent.class, "SENSOR_DOOR_TYPE_ISUNLOCKED");

	public static final String SENSOR_DOOR_TYPE_OPEN = IDUtil.getUniqueIdentifier(VisonicSensorComponent.class, "SENSOR_DOOR_TYPE_OPEN");
	public static final String SENSOR_DOOR_TYPE_CLOSE = IDUtil.getUniqueIdentifier(VisonicSensorComponent.class, "SENSOR_DOOR_TYPE_CLOSE");
	public static final String SENSOR_DOOR_TYPE_LOCK = IDUtil.getUniqueIdentifier(VisonicSensorComponent.class, "SENSOR_DOOR_TYPE_LOCK");
	public static final String SENSOR_DOOR_TYPE_UNLOCK = IDUtil.getUniqueIdentifier(VisonicSensorComponent.class, "SENSOR_DOOR_TYPE_UNLOCK");

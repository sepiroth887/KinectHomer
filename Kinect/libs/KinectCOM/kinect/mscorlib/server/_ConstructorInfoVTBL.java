...
/**
 * Represents VTBL for COM interface _ConstructorInfo.
 */
public class _ConstructorInfoVTBL extends IUnknownVTBL
{
    public _ConstructorInfoVTBL(CoClassMetaInfo classMetaInfo)
    {
        super(classMetaInfo);

...
/**
 * Represents Java interface for COM interface _MethodInfo.
 *
 *
 */
public interface _MethodInfo extends IUnknown
{
    public static final String INTERFACE_IDENTIFIER = "{FFCC1B5D-ECB8-38DD-9B01-3DC8ABC2AA5F}";
     ...
     * 
     */
    ICustomAttributeProvider getReturnTypeCustomAttributes()
        throws ComException;
}

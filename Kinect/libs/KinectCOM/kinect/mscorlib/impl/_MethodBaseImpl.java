...
/**
 * Represents COM interface _MethodBase.
 *
 *
 */
public class _MethodBaseImpl extends IUnknownImpl
    implements _MethodBase
{
    public static final String INTERFACE_IDENTIFIER = _MethodBase.INTERFACE_IDENTIFIER;
    private static final IID _iid = IID.create(INTERFACE_IDENTIFIER);

    public _MethodBaseImpl()
    {
    }

    protected _MethodBaseImpl(IUnknownImpl that) throws ComException
    {
        super(that);
    }

    public _MethodBaseImpl(IUnknown that) throws ComException
    {
        super(that);
    }

    public _MethodBaseImpl(CLSID clsid, ClsCtx dwClsContext) throws ComException
    {
        super(clsid, dwClsContext);
    }

    public _MethodBaseImpl(CLSID clsid, IUnknownImpl pUnkOuter, ClsCtx dwClsContext) throws ComException
    {
    ...
    public Object clone()
    {
        return new _MethodBaseImpl(this);
    }
}

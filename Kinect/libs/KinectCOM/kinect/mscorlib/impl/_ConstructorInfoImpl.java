...
/**
 * Represents COM interface _ConstructorInfo.
 *
 *
 */
public class _ConstructorInfoImpl extends IUnknownImpl
    implements _ConstructorInfo
{
    public static final String INTERFACE_IDENTIFIER = _ConstructorInfo.INTERFACE_IDENTIFIER;
    private static final IID _iid = IID.create(INTERFACE_IDENTIFIER);

    public _ConstructorInfoImpl()
    {
    }

    protected _ConstructorInfoImpl(IUnknownImpl that) throws ComException
    {
        super(that);
    }

    public _ConstructorInfoImpl(IUnknown that) throws ComException
    {
        super(that);
    }

    public _ConstructorInfoImpl(CLSID clsid, ClsCtx dwClsContext) throws ComException
    {
        super(clsid, dwClsContext);
    }

    public _ConstructorInfoImpl(CLSID clsid, IUnknownImpl pUnkOuter, ClsCtx dwClsContext) throws ComException
    {
    ...
    public Object clone()
    {
        return new _ConstructorInfoImpl(this);
    }
}

 ...
 */
public class FlashAutomationSample extends JFrame
{
    private static final String WINDOW_TITLE = "JNIWrapper - Shockwave Flash Automation";

    private static final String FLASH_PROGID = "ShockwaveFlash.ShockwaveFlash";

    private OleContainer _container = new OleContainer();

    public FlashAutomationSample()
    {
        super(WINDOW_TITLE);
    ...
    public void openFile(String filePath)
    {
        ...
        // get count of frames
        long framesCount = flashAutomation.getProperty("TotalFrames").getIntVal().getValue();
    ...
    public static void main(String[] args)
    {
        ...
        FlashAutomationSample sample = new FlashAutomationSample();
...
//-------------------------------------------------------------------------------------------------
    ...
    private class OpenFileActionListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (chooser.showOpenDialog(FlashAutomationSample.this) == JFileChooser.APPROVE_OPTION)
            {
